...
test("Deve calcular o total a pagar do estacionamento na praia, que custa 10 reais a hora", function() {
    const capacity = 500;
...
test("Deve calcular o total a pagar do estacionamento no shopping, que as primeiras 3 horas custam 10 reais e as horas seguintes custam 10 reais", function() {
    const capacity = 500;
...
test("Deve calcular o total a pagar do estacionamento no aeroporto, que tem a taxa única de 30 reais", function() {
    const capacity = 500;
    const parkingLot = new ParkingLot(capacity, "airport");
    parkingLot.checkin("AAA-8888", new Date("2021-03-01T10:00:00"));
    const ticket = parkingLot.calculateTicket("AAA-8888", new Date("2021-03-01T19:00:00"));
    parkingLot.checkout("AAA-8888");
    expect(ticket.price).toBe(30);
});