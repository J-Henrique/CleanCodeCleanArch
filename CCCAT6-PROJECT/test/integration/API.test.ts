...
test.skip("Deve retornar resultados de /orders", async function() {
...
test.skip("Deve retornar resultados de /order/code", async function() {
    const itemRepository = new ItemRepositoryMemory();
    itemRepository.save(new Item(1, "Guitarra", 1000, new Dimension(100, 30, 10), 3));
	itemRepository.save(new Item(2, "Amplificador", 5000, new Dimension(50, 50, 50), 20));
	itemRepository.save(new Item(3, "Cabo", 30, new Dimension(10, 10, 10), 1));
    ...
    const response = await axios({
        url: "http://localhost:3000/order/202100000001",
        method: "get"
    })
